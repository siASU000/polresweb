...
<head>
  ...
  <title>Dashboard - Polresta Padang</title>
  ...
  <style>
    ...
    .berita-main-item img {
      ...
      height: 100%;
      object-fit: cover;
      /* Menjamin gambar memenuhi kotak tanpa merusak rasio */
      display: block;
    }
...
<body>
  ...
  <section class="services" aria-label="Layanan utama">
    <a href="konten#sim" class="service-item" data-service="sim" id="serviceSimLink">
    ...
    <a href="konten#skck" class="service-item" data-service="skck" id="serviceSkckLink">
      ...
      <div>
        ...
        <p id="serviceSkckDesc">
          Polresta Padang melayani penerbitan Surat Keterangan Catatan Kepolisian (SKCK) untuk masyarakat di Kota
          Padang.
        </p>
      </div>
    </a>

    <a href="konten#spkt" class="service-item" data-service="spkt" id="serviceSpktLink">
        ...
        <?php foreach ($beritaTerkini as $b): ?>
          ...
          <div class="berita-main-item">
            ...
            <button class="btn-read" type="button"
              onclick="window.location.href='<?= !empty($b['slug']) ? 'berita/' . h($b['slug']) : 'berita-detail?id=' . (int) $b['id'] ?>'">
              BACA SELENGKAPNYA
            </button>
          </div>
        <?php endforeach; ?>
            ...
            while ($row = $res->fetch_assoc()):
              ...
              <div class="berita-item">
                ...
                <div class="berita-info">
                  ...
                  <a href="<?= !empty($row['slug']) ? 'berita/' . h($row['slug']) : 'berita-detail?id=' . (int) $row['id'] ?>"
                    class="berita-judul"><?= h($row['judul']) ?></a>
          ...
          foreach ($beritaPopuler as $bp):
            ...
            <div class="populer-item">
              <div class="populer-img-wrapper">
                <img src="<?= !empty($bp['gambar']) ? $uploadBase . $bp['gambar'] : 'assets/default.jpg' ?>"
                  class="populer-img">
              </div>
              <div class="populer-info">
                <a href="<?= !empty($bp['slug']) ? 'berita/' . h($bp['slug']) : 'berita-detail?id=' . $bp['id'] ?>"
                  class="populer-text-link">
...
<section class="container" style="padding: 0 20px;">
    <div class="cta-berita">
        <h3>Butuh Bantuan Kepolisian?</h3>
        <p>Jangan ragu untuk melaporkan kejadian mencurigakan atau meminta bantuan darurat. Kami siap melayani 24 Jam.</p>
