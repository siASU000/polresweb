  ...
  <section class="card profile-card">
    ...
    <div class="profile-right">
      <form id="profileForm" class="form-grid">
        ...
        <div class="field">
          <label>NRP</label>
          <input type="text" id="nrp" name="nrp" placeholder="Masukkan NRP" required inputmode="numeric"
        ...
        <div class="field">
          ...
          <input type="text" id="no_hp" name="no_hp" placeholder="Masukkan Nomor HP" required inputmode="numeric"
            autocomplete="off" maxlength="15" pattern="[0-9]+">
        </div>
